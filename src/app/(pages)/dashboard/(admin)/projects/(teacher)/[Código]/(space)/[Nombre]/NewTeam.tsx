...
//     params: { ID_Espacio: number };
// }

// const fetchSpaceByID = async (id: number): Promise<Space | null> => {
...
//     const space = spaces.find((space) => space.ID_Espacio === id);
//     return space || null;
// };
...
//             try {
//                 const spaceData = await fetchSpaceByID(params.ID_Espacio);
//                 if (spaceData) {
//                     setSpace(spaceData);
//                 } else {
...
//             }
//             if (space) {
//                 teamData.append('idteam', space.ID_Espacio.toString());
//             }
