...
export default function NewMember({ params, onNewMember }: NewMemberProps) {
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        try {
            ...
            await Promise.all(
                selectedUsers.map(async (userId) => {
                    const teamMemberData = {
                        idteam: teamId,
                        iduser: userId,
                        namerol: "Miembro de equipo", // Nombre del rol a asignar
                    };
            ...
            onOpenChange(); // Cerrar el modal después de agregar los miembros
        } catch (error) {
                            ...
                            <ModalBody>
                                ...
                                >
                                    {students.map((student) => (
                                        <SelectItem key={student.ID_Usuario ? student.ID_Usuario.toString() : `null-${student.ID_Siscode}`} textValue={student.Nombre}>
